// RFC 7541 Appendix B Huffman table and decoder — the ONE copy.
//
// `include!`d by:
//   * `modules/foundation/http/wire/hpack.rs`  — HTTP/2 header compression
//   * `modules/foundation/http/wire/qpack.rs`  — HTTP/3, via `qpack_decode_field_into`
//
...
// equality and prefix-freeness rather than trusting the bytes.
